...
-   It extracts name, regular price, offer price (if exists), quantity and other elements for each product.
    Cleaned each field extracted.
...
-   Voice assistant that uses Google API to improve speech-to-text.
    Created an SQLite schema to store data of neural network, audio features and users preferences.
